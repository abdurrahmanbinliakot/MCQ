...
from .models import MCQ,Class,Subject,Chapter,Articless
from .form import add_mcq_form,add_new_class,add_subject_name,add_chapter_name,MyForm
...
def ClassView(request):
    if request.method =="POST":
        ...
        if form.is_valid():
            ...
            add_class.save()
            form = add_new_class()
            print(f"Successfully Add {class_name}")
    else:
        form = add_new_class()
